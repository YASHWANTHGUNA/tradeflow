          ...
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              ...
              <span className="text-blue-600 font-bold">
                {merchantData?.storeDetails?.storeName || merchantData?.name}
              </span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            ...
            <span className="text-xs text-emerald-600 font-semibold mt-2 block">
              Settled via Razorpay Smart Route
            </span>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            ...
            <span className="text-xs text-blue-600 font-semibold mt-2 block">
              {inventory.length} Active Listings live
            </span>
          </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                        <Link
                          ...
                          className="text-blue-600 hover:text-blue-800 bg-blue-50 p-2 rounded-lg inline-flex items-center gap-1 transition"
                        >
